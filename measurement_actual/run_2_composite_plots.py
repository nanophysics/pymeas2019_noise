...
def run(dir_measurement):
    ...
    plot_data = library_topic.PlotDataMultipleDirectories(topdir=dir_measurement, plot_config=plot_config, presentations=presentations)
    plot_file = library_plot.PlotFile(plot_data=plot_data, plot_config=plot_config, presentations=presentations, write_files_directory=dir_measurement, title=config_measurement.TITLE)
    ...
    library_1_postprocess.postprocess(dir_measurement=dir_measurement, plot_data=plot_data)
